...
% Wrapped images + No label figure + footnote {{{

% you cant do it with the \lipsum cause it prints all at once
...
\begin{wrapfigure}[12]{R}[0pt]{0.25\textwidth}
	\centering
	%\rule{5cm}{5cm}
	\includegraphics[width=0.25\textwidth]{placeholder.jpg}
	\caption*{
...
\color{red}alskdfjalksdjfalksjd \color{black}
